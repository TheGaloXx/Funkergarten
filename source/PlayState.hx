...
class PlayState extends MusicBeatState
{
	...
	*/
	...
	private var camOffset:Int = (FlxG.save.data.camMove ? 30 : 0);
	...
	override public function create()
	{
		...
		if (storyDifficulty == 3 || FlxG.save.data.botplay)
		...
		//iconP1.shader = pixelShit.shader;
